(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["higlass-geojson"] = factory();
	else
		root["higlass-geojson"] = factory();
})(window, function() {
...
// CONCATENATED MODULE: ./src/GeoJsonTrack.js
...
var GeoJsonTrack_GeoJsonTrack = function GeoJsonTrack(HGC) {
...
GeoJsonTrack_GeoJsonTrack.config = {
  type: 'geo-json',
  datatype: ['geo-json'],
  orientation: '2d',
  name: 'GeoJSON',
...
/* harmony default export */ var src_GeoJsonTrack = (GeoJsonTrack_GeoJsonTrack);
...
src({
  name: 'GeoJsonTrack',
  track: src_GeoJsonTrack,
  config: src_GeoJsonTrack.config
});
